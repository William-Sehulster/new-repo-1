 ...
 *         &lt;element name="scReportDate" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ServiceConnectionAwardInfo {
    ...
    protected XMLGregorianCalendar scReportDate;
     ...
     *     
     */
    public XMLGregorianCalendar getScReportDate() {
        return scReportDate;
    }
     ...
     *     
     */
    public void setScReportDate(XMLGregorianCalendar value) {
        this.scReportDate = value;
    }
