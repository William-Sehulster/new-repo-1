...
FROM
  (SELECT pharm.ncpdp_id pharmacy_ncpdp_id,
    ...
    DECODE(inbmsg.patient_chk_status,'0002',1,0)  new_rx_mvi_pat_not_found,
    DECODE(inbmsg.patient_chk_status,'0101',1,0)  new_rx_ene_elgb_enrl,
    DECODE(inbmsg.patient_chk_status,'0102',1,0)  new_rx_ene_not_elgb_enrl,
    ...
    DECODE(inbmsg.drug_chk_status,'1002',1,0)  new_rx_drg_mtch_not_fnd,
    DECODE(inbmsg.provider_chk_status,'2001',1,0)  new_rx_pvd_mtch_fnd,
    DECODE(inbmsg.provider_chk_status,'2002',1,0)  new_rx_pvd_mtch_not_fnd,
