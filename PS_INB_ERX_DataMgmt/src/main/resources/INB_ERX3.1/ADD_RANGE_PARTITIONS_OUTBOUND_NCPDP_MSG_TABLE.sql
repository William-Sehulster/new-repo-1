--This script adds additional range partitions (3 years worth) to the outbound_ncpdp_msg table
...
ALTER TABLE erx.outbound_ncpdp_msg DROP PARTITION rcvd_date_p99
   UPDATE INDEXES;
