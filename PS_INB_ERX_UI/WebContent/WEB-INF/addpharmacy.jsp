...
<form:form id="pharmacyAddForm" name="pharmacyAddForm" commandName="pharmacyAddForm" method="POST" action="${pageContext.request.contextPath}/inb-erx/managePharm/addNewPharmacy">
...
<div id="pharmacyManagement">
	...
	<input id="visn" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.visn}"  size="2" maxlength="2" style="display: block; opacity: 1;" name="visn" title="Veteran Integrated Service Network of pharmacy">
	</div>	
	...
	<input id="vaStationId" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.vaStationId}"  size="20" maxlength="10" style="display: block; opacity: 1;" name="vaStationId" title="VA Station ID of pharmacy">
	</div>
	...
	<input id="pharmacyZipcode" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.pharmacyZipcode}"  size="20"  maxlength="10" style="display: block; opacity: 1;" name="pharmacyZipcode" title="Pharmacy's zip code">
	</div>
	...
	Active Start Time:<span class="pharmacyAddFormReadOnlyField">(Read Only)</span>    
	</label>
    ...
    Active End Time:<span class="pharmacyAddFormReadOnlyField">(Read Only)</span>    
	...
	<input id="binLocationNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.binLocationNumber}"  size="15" maxlength="35" style="display: block; opacity: 1;" name="binLocationNumber" title="Pharmacy Identifier">
	</div>
	...
	<input id="deaNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.deaNumber}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="deaNumber" title="Pharmacy's DEA Number">
	</div>
	...
	<input id="email" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.email}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="email" title="Pharmacy's email address">
	</div>
	...
	<input id="hin" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.hin}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="hin" title="Pharmacy's Health Industry Number">
	</div>
	...
	<input id="medicaidNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.medicaidNumber}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="medicaidNumber" title="Pharmacy's Medicaid Number">
	</div>
	...
	<input id="medicareNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.medicareNumber}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="medicareNumber" title="Pharmacy's Medicare Number">
	</div>
	...
	<input id="naicCode" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.naicCode}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="naicCode" title="Pharmacy's NAICS Code">
	</div>
	...
	<input id="storeNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.storeNumber}"  size="20" maxlength="35"  style="display: block; opacity: 1;" name="storeNumber" title="Pharmacy's ID number">
	</div>
	...
	<input id="payerId" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.payerId}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="payerId" title="Pharmacy's Payer ID">
	</div>
	...
	<input id="pharmacistAgentPrefix" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.pharmacistAgentPrefix}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="pharmacistAgentPrefix" title="Prefix for pharmacist agent">
	</div>
	...
	<input id="pharmacistAgentFirstName" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.pharmacistAgentFirstName}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="pharmacistAgentFirstName" title="Pharmacist's Agent first name">
	</div>	
	...
	<input id="pharmacistAgentMiddleName" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.pharmacistAgentMiddleName}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="pharmacistAgentMiddleName" title="Pharmacist's Agent middle name">
	</div>
	...
	<input id="pharmacistAgentLastName" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.pharmacistAgentLastName}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="pharmacistAgentLastName" title="Pharmacist's Agent last name">
	</div>	
	...
	<input id="pharmacistAgentSuffix" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.pharmacistAgentSuffix}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="pharmacistAgentSuffix" title="Pharmacist's Agent suffix">
	</div>
	...
	<input id="ppoNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.ppoNumber}"  size="20"  maxlength="35" style="display: block; opacity: 1;" name="ppoNumber" title="Pharmacy's PPO number">
	</div>
	...
	<input id="promotionNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.promotionNumber}"  size="20"  maxlength="35" style="display: block; opacity: 1;" name="promotionNumber" title="Pharmacy Identifier">
	</div>
	...
	<input id="secondaryCoverage" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.secondaryCoverage}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="secondaryCoverage" title="Pharmacy Identifier">
	</div>
	...
	<select multiple id="serviceLevel" class="editable pharmAddScreen" style="display: block; opacity: 1;" name="serviceLevel">	  
	...
	<select   id="specialtyId" class="editable pharmAddScreen" style="display: block; opacity: 1;" name="specialtyId">	  
	...
	<input id="stateLicenseNumber" class="editable pharmAddScreen" type="text" value="${ pharmacyInfo.stateLicenseNumber}"  size="20" maxlength="35" style="display: block; opacity: 1;" name="stateLicenseNumber">
	</div>
	...
	<select id="twentyFourHourFlag" class="editable pharmAddScreen" style="display: block; opacity: 1;" name="twentyFourHourFlag">   
