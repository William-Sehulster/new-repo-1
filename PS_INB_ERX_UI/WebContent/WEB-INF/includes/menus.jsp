...
<inb-erx:menuItem name="Home" path="inb-erx/homepage" id="index" tabindex="0" />
...
<inb-erx:menuItem name="Track/Audit" path="inb-erx/track/main"  id="trackeRx" pagePermissions="SYSTEM_ADMN,PHARM_MGR,PBM_ADMN,PHARM_USER"/>	
<inb-erx:menuItem name="Reports" path="inb-erx/reports/main"  id="reports" pagePermissions="SYSTEM_ADMN,PHARM_MGR,PBM_ADMN,PHARM_USER,READONLY"/>
