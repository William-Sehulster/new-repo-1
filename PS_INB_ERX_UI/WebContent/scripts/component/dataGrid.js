...
function buildSummaryReportTotalsGrid(parentContainer, gridData, recordsTotal) {
	...
	sumTable = 
		...
		"<table id='summaryReportTable' style='width:1123px;'>" +
		"<tr>" +
		"<td class='summaryReportTotalsTd' style='width:13px; text-align: left;'>&nbsp;</td>" +
		"<td class='summaryReportTotalsTd' style='width:13px; text-align: left;'>&nbsp;</td>" +
		"<td class='summaryReportTotalsTd' style='width:13px; text-align: left;;'>&nbsp;</td>" +
		"<td class='summaryReportTotalsTd' style='width:13px; text-align: left;'>&nbsp;</td>" +
		"<td class='summaryReportTotalsTd' style='width:73px; text-align: right; font-weight: bold;'>Totals >>></td>" +
	...
	"</table>"+"<script type=\"text/javascript\">adjustWidths();</script>";
...
function buildRejectReasonsReportTotalsGrid(parentContainer, gridData, recordsTotal) {
	...
	sumTable = 
		...
		"<table style='width:100%; table-layout: fixed;'>" +
		"<tr>" +
		"<td class='summaryReportTotalsTd' style='width:100px; text-align: right; font-weight: bold;'>Totals >>></td>" +
...
function generateDivTable(layout, gridData, dataGridDivId) {
		...
		var divTableStart = "<div class=\"generatedReportsDivTable\" id=\"generatedDivTableID\" tabindex=\"0\" role=\"table\" aria-label=\"Pharmacies\ Table\" aria-describedby=\"divTableInfo\">";
		var divTableEnd = "</div>" ;
