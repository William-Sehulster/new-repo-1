...
public class Pharmacy implements java.io.Serializable {
	...
	private static final long serialVersionUID = 504242151393396591L;
	...
	public Pharmacy(Long pharmacyId, String vaStationId,
			String ncpdpId, String storeName,
	...
	public Pharmacy(Long pharmacyId, String createdBy, String updatedBy,String vaStationId, 
			String ncpdpId, Long npi, 
			String storeName,
	...
	@Column(name = "PHARMACY_FAX_NUMBER", nullable = false, length = 35)
